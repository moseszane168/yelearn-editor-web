    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.name" placeholder="物料名称" class="handle-input mr10 w150"></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="data_update_time" label="更新时间"></el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/cust/CustomsBook/index', {
                params: this.query
            }).then((res) => {
