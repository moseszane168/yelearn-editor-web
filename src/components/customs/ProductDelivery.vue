    ...
    <div>
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="product_cd" label="成品编码"></el-table-column>
                <el-table-column prop="product_desc" label="成品名称" width="180"></el-table-column>
                <el-table-column prop="delivery_type_name" label="类型"></el-table-column>
                <el-table-column prop="book_num" label="帐册编号"></el-table-column>
                <el-table-column prop="calc_unit" label="计量单位"></el-table-column>
                <el-table-column prop="delivery_cnt" label="出库数"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/cust/ProductDelivery/index', {
                params: this.query
            }).then((res) => {
