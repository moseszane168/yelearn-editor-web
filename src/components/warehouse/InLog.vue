        ...
        <div class="container">
            ...
            <div class="handle-box">
                ...
                <el-select v-model="query.mat_code" multiple filterable remote reserve-keyword
                    ...
                    <el-option v-for="item in mat_options" :key="item.mat_code" :label="item.label"
                        :value="item.mat_code">
                ...
                <!-- 仓库 -->
                {{ $t('default.Warehouse') }}：
                <el-select filterable v-model="query.ware_id" class="w200">
...
export default {
    ...
    methods: {
        ...
        getSendReceiving() {
            var token = localStorage.getItem("token");
            this.axios.post('/ware/SendReceiving/InSendReceiving', {
                token: token
            }).then((res) => {
