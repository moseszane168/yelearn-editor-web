    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="handle-box">
                用户编码:<el-input v-model="query.user_code" placeholder="用户编码" class="handle-input mr10"></el-input>
                 <!-- 推送状态 -->
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="user_code" label="用户编码"></el-table-column>
                <!-- 类型 -->
                ...
                <el-table-column prop="data" label="提交参数"></el-table-column>
                <el-table-column prop="return_date" label="返回参数"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/u8api/U8Bdpsn/index', {
                params: this.query
            }).then((res) => {
        ...
        Push() {
            ...
            if (length) {
                ...
                this.axios.post('/u8api/U8Bdpsn/Pust', {
                    token: localStorage.getItem("token"),
                    id_arr: id_arr,
                    params: this.form
