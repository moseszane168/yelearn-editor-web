    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="handle-box">
                入库编码:<el-input v-model="query.code" :placeholder="$t('default.Please_enter_a_keyword')" class="handle-input mr10"></el-input>
                 <!-- 推送状态 -->
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="code" label="入库编码"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/u8api/U8Otherin/index', {
                params: this.query
            }).then((res) => {
