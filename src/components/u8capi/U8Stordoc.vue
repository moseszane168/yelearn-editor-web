    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="handle-box">
                仓库编码:<el-input v-model="query.storcode" placeholder="仓库编码" class="handle-input mr10"></el-input>
                 <!-- 推送状态 -->
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="storcode" label="仓库编码"></el-table-column>
              <el-table-column prop="push_name" label="推送状态"></el-table-column>

                <el-table-column prop="data" width="300" label="提交参数"></el-table-column>
                <el-table-column prop="return_date" width="300" label="返回参数"></el-table-column>
                <!-- 创建时间 --> 
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/u8api/U8Stordoc/index', {
                params: this.query
            }).then((res) => {
        ...
        Push() {
            ...
            if (length) {
                ...
                this.axios.post('/u8api/U8Stordoc/Pust', {
                    token: localStorage.getItem("token"),
                    id_arr: id_arr,
                    params: this.form
