    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="handle-box">
                发票号:<el-input v-model="query.inv_code" placeholder="发票号" class="handle-input mr10"></el-input>
                 <!-- 推送状态 -->
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="no"  width="55" label="序号"></el-table-column>
                <el-table-column prop="inv_code" label="发票号"></el-table-column>
                <!-- 类型 -->
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/u8api/U8Invoice/index', {
                params: this.query
            }).then((res) => {
