    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="handle-box">
                {{$t('default.Purchase_Order_Number')}}:<el-input v-model="query.pur_code" placeholder="" class="handle-input mr10 w150"></el-input>
                 <!-- 推送状态 -->
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="push_name" label="推送状态"></el-table-column>
                ...
                <el-table-column prop="return_date" width="300" label="返回参数">
                    <template v-slot="scope">
                        <el-popover trigger="hover" placement="top">
                            ...
                            <div slot="reference" class="name-wrapper">
                                <el-button type="text" style="color: rgb(39, 36, 36);">{{ scope.row.return_date
                                    }}</el-button>
                            </div>
                        </el-popover>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/u8api/U8Order/index', {
                params: this.query
            }).then((res) => {
