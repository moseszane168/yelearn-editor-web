    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="handle-box">
                单据号:<el-input v-model="query.code" :placeholder="$t('default.Please_enter_a_keyword')" class="handle-input mr10"></el-input>
                 <!-- 推送状态 -->
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column prop="code" label="单据号" width="110"></el-table-column>

                <el-table-column prop="push_name" label="推送状态" width="80"></el-table-column>
                ...
                <el-table-column prop="return_date" width="300" label="返回参数">
                    <template v-slot="scope">
                        <el-popover trigger="hover" placement="top">
                            <p>{{ scope.row.return_date }}
                                {{ scope.row.return_date }}</p>
                            <div slot="reference" class="name-wrapper">
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.axios.get('/u8api/U8Purchasein/index', {
                params: this.query
            }).then((res) => {
